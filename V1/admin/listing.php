...
<div class="contenu">
	<div class="titre"><a class="a-titre" href="index.html">Accueil City-Mix </a> »Listing des commerces</div>
	
	<h3> Poster un commerce </h3>
<hr>
...
try
{
    $bdd = new PDO('mysql:host=127.0.0.1;dbname=v1;charset=utf8', 'localhost', '1478965');
}
catch(Exception $e)
{
